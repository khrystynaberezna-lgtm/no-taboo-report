#!/usr/bin/env python3
"""Generate NO TABOO report (index.html) from Databricks.
...
Параметри звіту (нижче в коді):
  PARTNER_NAME    = "NO TABOO"   # точне значення dim_provider_v2.group_name
  PARTNER_DISPLAY = "NO TABOO"   # людська назва для логів, заголовка і JSON
